...
export default function TeamSection() {
    return (
        <Section color="black">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 xl:gap-8 mt-11">
                {team.map((items, index) => (
                    <div key={index} className="relative group w-full h-[442px] rounded-3xl border-2 border-[#FFFFFF]/80 overflow-hidden shadow-lg"
                    >
                        <Image
