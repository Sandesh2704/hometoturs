...
//                         <div className="border border-[#01162752] px-8 py-6 rounded-2xl mt-8">
...
//                                     className={`w-full px-3 md:px-6 py-3 rounded-3xl flex items-center justify-between gap-4 ${selectedQuestion === faq.id
...
//                                         {faq.question}
//                                     </span>
//                                     <div className={`p-2 md:p-3 text-xl lg:text-2xl rounded-full
